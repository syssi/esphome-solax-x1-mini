...
sys.modules["esphome.components.solax_modbus"] = _make_modbus_mock(
    "solax_modbus", "SolaxModbusDevice"
)
sys.modules["esphome.components.solax_meter_modbus"] = _make_modbus_mock(
